...
class LLMJudge:
    ...
    def _create_evaluation_prompt(
        ...
        return f"""
You are an expert evaluator assessing a Sports Analyst agent's response.
...
Focus on:
- Accuracy of sports statistics and analysis
- Appropriate tool usage for sports analysis queries
- Clear and insightful sports analysis responses
- Proper handling of different query types (player stats, team performance, game analysis)
- Professional sports analyst tone and structure
- Depth of sports knowledge and insights provided
