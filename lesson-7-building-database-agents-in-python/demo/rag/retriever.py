...
async def retrieve(query: str, k: int = 5):
    ...
    try:
        ...
        # Fallback to mock sports data
        return [
            {"id": "lakers-001", "text": "Los Angeles Lakers: NBA team based in Los Angeles. Current record: 15-10. Key players: LeBron James, Anthony Davis, Austin Reaves. Recent performance: Won 3 of last 5 games. Next game: vs Golden State Warriors."},
            {"id": "lebron-001", "text": "LeBron James: Lakers forward, 39 years old. Season stats: 25.2 PPG, 7.8 RPG, 6.8 APG. Recent form: Excellent, averaging 28 points in last 5 games. Injury status: Healthy. Contract: 2 years remaining."}
        ]
