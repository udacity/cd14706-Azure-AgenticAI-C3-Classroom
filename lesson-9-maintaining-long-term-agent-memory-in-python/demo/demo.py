#!/usr/bin/env python3
"""
Demo script for Lesson 9: Maintaining Long-Term Agent Memory in Python - Sports Analyst Agent

This script demonstrates the key learning objectives for a sports analyst agent:
...
async def demo_memory_pruning_and_reordering():
    """
    Demonstrate memory pruning and reordering for better performance in a sports analyst agent.
    This showcases the core learning objectives of the lesson.
    """
    print("🏈 Lesson 9: Maintaining Long-Term Agent Memory in Python - Sports Analyst Agent")
    print("=" * 80)
    ...
    # Add sports analyst memories with varying importance to demonstrate pruning
    print("📝 Adding sports analyst memories with varying importance levels...")
    
    memories_data = [
        ("session_001", "Lakers won the championship last season", "conversation", 0.9, ["basketball", "championship", "lakers"]),
        ("session_001", "Weather is sunny today", "conversation", 0.2, ["weather", "daily"]),
        ("session_001", "Important playoff game approaching", "conversation", 0.8, ["basketball", "playoffs", "urgent"]),
        ("session_001", "Random thought about coffee", "conversation", 0.1, ["personal", "coffee"]),
        ("session_001", "Player completed major milestone", "system_event", 0.9, ["basketball", "milestone", "achievement"]),
        ("session_001", "Casual conversation about weekend games", "conversation", 0.3, ["basketball", "weekend"]),
        ("session_001", "Critical injury report occurred", "system_event", 0.95, ["basketball", "injury", "urgent"]),
    ]
    ...
    # Search by content
    basketball_memories = ltm.search_memories("session_001", query="basketball")
    print(f"   • Basketball-related memories: {len(basketball_memories)}")
    
    print(f"\n🏆 Lesson 9 Sports Analyst Agent Demonstration Complete!")
    print("=" * 80)
    ...
    print("   ✓ Applied sports analyst domain knowledge to memory management")
    print("=" * 80)
